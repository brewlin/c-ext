...
{
    PHP_ME(lib_coroutine_util,create,arginfo_php_coroutine_create,ZEND_ACC_PUBLIC | ZEND_ACC_STATIC)
    PHP_FE_END
};
...
{
    INIT_NS_CLASS_ENTRY(php_coroutine_ce,"Lib","Coroutine",lib_coroutine_util_methods);
